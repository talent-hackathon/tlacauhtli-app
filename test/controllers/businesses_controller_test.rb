...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create business' do
    assert_difference('Business.count') do
      post businesses_url,
           params: { business: { adress: @business.adress, business_name: @business.business_name, phone: @business.phone,
                                 photo: @business.photo, rfc: @business.rfc, state: @business.state, state_code: @business.state_code } }
    end
